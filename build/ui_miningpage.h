...
public:
    ...
    void retranslateUi(QWidget *MiningPage)
    {
        ...
        typeBox->insertItems(0, QStringList()
         << QApplication::translate("MiningPage", "Solo Flying (mining)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("MiningPage", "Pool Flying (mining)", 0, QApplication::UnicodeUTF8)
        );
